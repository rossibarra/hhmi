...
%- Domestication: demography, selection on genome and phenotypes
%- Local adaptation: architecture, biotic interactions, climate, introgression
%- Experimental evolution: selection during breeding
%- Genome evolution: TEs, CNVs, linked selection
